        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="lg:w-2/5">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 mb-8 border border-gray-100 dark:border-gray-700">
              {/* Foto Profil */}
              <div className="relative w-56 h-56 mx-auto rounded-full overflow-hidden border-4 border-white dark:border-gray-700 shadow-xl mb-6 group">
          ...
          <div className="lg:w-3/5">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 mb-8 border border-gray-100 dark:border-gray-700">
              ...
              <div className="space-y-5">
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                  I&apos;m a passionate informatics engineering student at UDB with a
                  strong interest in creative fields and technology. My journey
                  in programming started during my university studies, and I&apos;ve
                  been continuously exploring and learning ever since.
                </p>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 border border-gray-100 dark:border-gray-700">
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-blue-500 pl-5 py-3 bg-blue-50 dark:bg-blue-900/20 rounded-r-lg">
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                    High-School
                  </h3>
                  <p className="text-gray-600 dark:text-gray-400">
                    SMAN 6 SURAKARTA, 2021-2024
                  </p>
                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                    MIPA 6  
                  </p>
                </div>
                <div className="border-l-4 border-purple-500 pl-5 py-3 bg-purple-50 dark:bg-purple-900/20 rounded-r-lg">
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                ...
                <div className="border-l-4 border-green-500 pl-5 py-3 bg-green-50 dark:bg-green-900/20 rounded-r-lg">
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                    UI/UX Design Fundamentals
                  </h3>
                  <p className="text-gray-600 dark:text-gray-400">
                    Workshop Completion, 2023
                  </p>
                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
